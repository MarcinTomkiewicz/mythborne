...
export function mapDirectTradeTransactionItem(
  ...
  return {
    ...
    generationBaseId: row.generation_base_id_snapshot,
    generationBaseKey: row.generation_base_key_snapshot,
    generationBaseName: row.generation_base_name_snapshot,
    generationBaseTypeKey: row.generation_base_type_key_snapshot,
    generationQualityKey: row.generation_quality_key_snapshot,
    generationQualityLabel: row.generation_quality_label_snapshot,
    hasPrefix: row.has_prefix_snapshot,
    hasSuffix: row.has_suffix_snapshot,
    itemSnapshotJson: row.item_snapshot_json,
    prefixAffixId: row.prefix_affix_id_snapshot,
    prefixAffixKey: row.prefix_affix_key_snapshot,
    prefixAffixName: row.prefix_affix_name_snapshot,
    suffixAffixId: row.suffix_affix_id_snapshot,
    suffixAffixKey: row.suffix_affix_key_snapshot,
    suffixAffixName: row.suffix_affix_name_snapshot,
    valueBucket: row.value_bucket_snapshot,
    createdAt: row.created_at,
  };
}
