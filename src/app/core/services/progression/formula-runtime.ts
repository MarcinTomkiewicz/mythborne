  ...
  private readonly functionGuides: readonly FormulaFunctionGuide[] = [
    {
      ...
      example: 'pow(currentLevel, 1.45)',
      exampleHuman: 'currentLevel^1.45',
      insertTemplate: 'pow(currentLevel, 1.45)',
    },
    {
      key: 'roundUp',
      label: 'roundUp()',
      ...
      example: 'roundUp(4 + currentLevel * 2 + pow(currentLevel, 1.45), 5)',
      exampleHuman: 'round up (4 + currentLevel * 2 + currentLevel^1.45) to step 5',
      insertTemplate: 'roundUp(currentLevel * 10, 5)',
    },
    {
      key: 'roundDown',
      label: 'roundDown()',
      ...
      insertTemplate: 'roundDown(currentLevel * 10, 5)',
    },
    {
      key: 'round',
      label: 'round()',
      ...
      insertTemplate: 'round(currentLevel * 1.2)',
    },
    {
      key: 'floor',
      label: 'floor()',
      ...
      insertTemplate: 'floor(currentLevel / 2)',
    },
    {
      key: 'ceil',
      label: 'ceil()',
      ...
      example: 'ceil(currentLevel / 2)',
      exampleHuman: 'always round currentLevel / 2 up',
      insertTemplate: 'ceil(currentLevel / 2)',
    },
    {
      key: 'min',
      label: 'min()',
      ...
      example: 'min(currentLevel * 3, 100)',
      exampleHuman: 'pick the smaller of currentLevel * 3 and 100',
      insertTemplate: 'min(currentLevel * 3, 100)',
    },
    {
      key: 'max',
      label: 'max()',
      ...
      insertTemplate: 'max(currentLevel * 3, 10)',
    },
    {
      key: 'clamp',
      label: 'clamp()',
      ...
      example: 'clamp(10, 80, currentLevel * 4)',
      exampleHuman: 'keep currentLevel * 4 between 10 and 80',
      insertTemplate: 'clamp(10, 80, currentLevel * 4)',
    },
    {
      key: 'abs',
      label: 'abs()',
      ...
      example: 'abs(currentLevel - rank)',
      exampleHuman: 'distance between currentLevel and rank',
      insertTemplate: 'abs(currentLevel - rank)',
    },
    {
      key: 'random',
      label: 'random()',
