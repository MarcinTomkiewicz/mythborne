...
- Epic T Guild Foundation is accepted through T2. T0 verified current generated guild DB/RPC types; T1 added guild domain models, RPC type aliases and mapper tests; T2 added the canonical guild read service and current guild state. Next Epic T implementation task is T3 - Guild discovery and search.
