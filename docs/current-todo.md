...
- Current backlog task: L5 - start step timer and progress UI.
...
- Next: L5 should add step timer/progress display from DB `resolves_at`/step status and ready-to-resolve handling.
