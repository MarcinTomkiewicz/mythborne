...
- Epic T Guild Foundation is accepted through T1. T0 verified current generated guild DB/RPC types; T1 added guild domain models, RPC type aliases and mapper tests. Next Epic T implementation task is T2 - Guild read service and current guild state.
