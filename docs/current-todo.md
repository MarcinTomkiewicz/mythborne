...
- Next backlog task: P8 - Attach reward drops to reports through approved producer path from `docs/codex-mythborne-backlog.md`, after the user commit and explicit start instruction.
- P2-P7 follow-ups: full manual smoke for list/detail/public-route/combat-rendering/item-reference rendering/unread/remove and low-level combat report creation needs representative report producer/combat result data.
