...
- Next backlog task: Q1 - Notification read model/service foundation from `docs/codex-mythborne-backlog.md`, after the user commit and explicit start instruction.
