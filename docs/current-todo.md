...
- Next backlog task: P9 - Trial and encounter report producer readiness from `docs/codex-mythborne-backlog.md`, after the user commit and explicit start instruction.
- P2-P8 follow-ups: full manual smoke for list/detail/public-route/combat-rendering/item-reference rendering/unread/remove, low-level combat report creation and reward-drop attachment needs representative report producer/combat result/item data.
