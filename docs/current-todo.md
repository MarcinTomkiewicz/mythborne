...
- Next backlog task: P7 - Reward/drop item reference display from `docs/codex-mythborne-backlog.md`, after the user commit and explicit start instruction.
- P2-P6 follow-ups: full manual smoke for list/detail/public-route/combat-rendering/unread/remove and low-level combat report creation needs representative report producer/combat result data.
