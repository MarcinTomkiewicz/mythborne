...
- H21 full manual smoke is deferred until representative gameplay cases and CP penalty data exist. Later smoke should cover complete, cancel, forgive and fail flows on real CP penalties with staff session context. H22 remains the broader repeat-offender/history slice for hero/account history beyond the selected case detail.
