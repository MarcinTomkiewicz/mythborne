...
- H19 UI/submission must use the safe server-scoped hero/account target-search pattern from H13 for sanction targets and must not introduce UUID-only target fields.
