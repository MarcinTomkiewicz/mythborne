...
| Combat | 45% | Canonical combat contracts, opponent resolution, attack plans, initiative, core resolution, result persistence and a temporary `/game/combat` Walking Dead test surface exist. Production encounter/trial/PvP consequences remain caller-owned and not wired. |
