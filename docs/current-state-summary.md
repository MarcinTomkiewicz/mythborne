...
| Combat | 50% | Canonical combat contracts, opponent resolution, attack plans, initiative, core resolution, result persistence, a temporary `/game/combat` Walking Dead test surface and read-only admin/balance inspection tooling exist. Production encounter/trial/PvP consequences remain caller-owned and not wired. |
